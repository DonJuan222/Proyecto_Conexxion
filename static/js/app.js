...
$(function() {
    ...
    var loginValidationSettings = {
	    ...
	    messages: {
	        username: {
	            required: "Por favor, inserte su usuario",
	            email: "Inserte un correo valido"
	        },
	        password:  "Por favor, inserte su contraseña",
	        agree: "Por favor acepte nuestras condiciones"
	    },
...
{
	let claseErrores = "error-personal" // nombre de clase
	let error = false
	let mensaje = ""
	...
	if(tipo == 'producto')
	{
		...
		if(nombreProducto.value == '')
		{
			...
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-La descripcion del producto no puede estar vacia. </p>"
		}
		...
		if(precioProducto.value == "0" || precioProducto.value == "")
		{
			error = true
			mensaje += "<p class= '" + claseErrores +" '>" +
			"Debe colocar un precio mayor a cero. </p>"
		}
	...
	if(tipo == 'pedido')
	{
		...
		if( productos.value <= 0 )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-Tiene que poner al menos un producto en el campo. </p>"				
		}
	...
	if(tipo == 'proveedor')
	{
		...
		if( (isNaN(parseFloat(cedula.value)) ) )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-La cedula es obligatoria y solo puede llevar numeros. </p>"
		}
		...
		if( (nombre.value.length) > 50 )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-El nombre no puede ser mayor a 50 caracteres. </p>"			
		}
		...
		if( (apellido.value.length) > 80 )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-El apellido no puede ser mayor a 70 caracteres. </p>"				
		}

		if( (isNaN(parseFloat(telefono.value)) ) )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
	...
	if(tipo == 'cliente')
	{
		...
		if( (isNaN(parseFloat(cedula.value)) ) )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-La cedula es obligatoria solo puede llevar numeros. </p>"
		}
	...
	if(tipo == 'usuario')
	{
		...
		if( (username.value.length) > 150 )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-El nombre de usuario no puede ser mayor a 150 caracteres. </p>"			
		}
		...
		if( (last_name.value.length) > 80 )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-El apellido no puede ser mayor a 80 caracteres. </p>"			
		}
		...
		if( password.value != rep_password.value )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-Las contraseñas tienen que ser iguales. </p>"				
		}
